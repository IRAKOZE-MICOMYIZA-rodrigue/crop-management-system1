-- Perfect Database schema matching all DAO requirements

-- Create users table (matches UserDAO exactly)
...
-- Create crop_types table (matches CropTypeDAO exactly)
...
-- Create crops table (matches CropDAO exactly)
...
-- Create sales table (matches SaleDAO exactly)
...
-- Insert default crop types (using crop_name column)
